...
class ChangePasswordPageLocators():
     change_password_form = (By.CSS_SELECTOR, ".page.account-page.change-password-page")
     change_password_title = (By.CSS_SELECTOR, "div.page account-page change-password-page div.page-title h1")
     old_password_field = (By.CSS_SELECTOR, "#OldPassword")
     old_password_label = (By.CSS_SELECTOR, "label[for='OldPassword']")
     new_password_field = (By.CSS_SELECTOR, "#NewPassword")
     new_password_label = (By.CSS_SELECTOR, "label[for='NewPassword']")
     confirm_password_field = (By.CSS_SELECTOR, "#ConfirmNewPassword")
     confirm_password_label = (By.CSS_SELECTOR, "label[for='ConfirmNewPassword']")
     change_password_btn = (By.CSS_SELECTOR, ".button-1.change-password-button")
     result_msg = (By.CSS_SELECTOR, "div.page.account-page.change-password-page div.result")
     password_is_required_error_input = (By.CSS_SELECTOR, ".text-box.single-line.password.input-validation-error")
     password_is_required_error_msg = (By.CSS_SELECTOR, "span.field-validation-error span[for='ConfirmNewPassword']")
     validation_error = (By.CSS_SELECTOR, "div.validation-summary-errors ul li")
     invalid_password_msg = (By.CSS_SELECTOR, "span.field-validation-error span[for='NewPassword']")
     new_password_is_required_error_msg = (By.CSS_SELECTOR, "span.field-validation-error span[for='NewPassword']")
     old_password_is_required_error_msg = (By.CSS_SELECTOR, "span.field-validation-error span[for='OldPassword']")